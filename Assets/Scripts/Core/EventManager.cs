...
namespace Game.Core
{
    // All of our C# events in one place. Static so any script can subscribe
    // with just the class name, no need to find the object first.
    ...
    public class EventManager : MonoBehaviour
    {
        ...
        public delegate void LightningHandler(LightningArgs e);
        ...
        public static event LightningHandler OnLightning;

        // Events are only ever fired from here.
        ...
        public static void RaiseTomeFound(TomeFoundArgs e) => OnTomeFound?.Invoke(e);
        public static void RaiseLightning(LightningArgs e) => OnLightning?.Invoke(e);

        // Called on scene load so we don't hold references to dead objects.
